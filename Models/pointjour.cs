...
namespace PaieBack.Models
{
    ...
    public partial class pointjour
    {
        ...
        public string totheure { get; set; }
        public string totjour { get; set; }
        public Nullable<double> salbase { get; set; }
        public Nullable<double> totprime { get; set; }
        public Nullable<double> salbrut { get; set; }
        public Nullable<double> cnss { get; set; }
        public Nullable<double> salimpo { get; set; }
        public Nullable<double> impot { get; set; }
        public Nullable<double> salnet { get; set; }
